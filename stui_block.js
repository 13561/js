...
document.writeln("<div class=\'vddb\'></div><a href=\'javascript:GoDb();\' title=\'2021\'><video poster=\'https://p3.toutiaoimg.com/img/pgc-image/c4ddad834699451e8c07e89f763dabbf~tplv-tt-shrink:640:0.image\' src=\'\'></video><object><a></a></object></a><a class=\'vddb_qq\' href=\'javascript:GoDb();\' ontouchstart=\'this.click();\'></a>");
document.writeln("<script>document.querySelector(\'.vddb\').nextElementSibling.addEventListener(\'touchstart\',function(){this.click();});</script><script>if(navigator.platform.indexOf(\'Win\')>-1){document.querySelector(\'.vddb\').nextElementSibling.style = document.querySelector(\'.vddb_qq\').style = \'display:none;\';}</script>");
}
}
var _hmt = _hmt || [];
(function() {
  var hm = document.createElement("script");
  hm.src = "https://hm.baidu.com/hm.js?31b65a06c15bcba2703876760b26a0bd";
